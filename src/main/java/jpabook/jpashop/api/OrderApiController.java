...
public class OrderApiController {
    ...
    public List<Order> ordersV1() { // 엔티티 반환 문제
    ...
    public List<OrderDto> ordersV2() { // N + 1 문제
    ...
    public List<OrderDto> ordersV3() { // 페이징이 안되는 문제
    ...
    public List<OrderQueryDto> ordersV4() { // DTO 버전 1, N+1문제
        return orderQueryRepository.findOrderQueryDtos();
    }

    @GetMapping("/api/v5/orders")
    public List<OrderQueryDto> ordersV5() { // DTO 버전 2
        return orderQueryRepository.findAllByDto_optimization();
    }

    @GetMapping("/api/v6/orders")
    public List<OrderQueryDto> ordersV6() { // DTO 버전 3
